...
if __name__ == '__main__':
    ...
    for _ in range(100):
        ...
        #创建时间，使用fake的API接口fake.date_time_between（），该方法接受三个参数，其中第一个是起始时间，第二个是终止时间
        #第三个为时区，时区为 get_current_timezone 返回的时区，这个函数是django.utils.timezone 模块的辅助函数，它会根据 django 设置文件中 TIME_ZONE的值返回对应的时区对象。
